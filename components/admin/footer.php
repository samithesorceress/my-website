	...
	<footer id="footer">
		<nav id="footer_menu">
			<ul><?php
				echo "<li><a href='" . $GLOBALS["htp_root"] . "logout'>Logout</a></li>";
			?></ul>
		</nav>
	...
	<link href="<?php echo $GLOBALS["htp_root"]; ?>src/css/Admin.css" rel="stylesheet" media="all">
	<script src="<?php echo $GLOBALS["htp_root"]; ?>functions/utils.js"></script>
	<script src="<?php echo $GLOBALS["htp_root"]; ?>functions/forms.js"></script>
	<script src="<?php echo $GLOBALS["htp_root"]; ?>components/dialogBox.js"></script>
	<script src="<?php echo $GLOBALS["htp_root"]; ?>components/admin/mediaBrowser.js"></script>
	<script src="<?php echo $GLOBALS["htp_root"]; ?>functions/selectItems.js"></script>
